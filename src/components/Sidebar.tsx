...
const adminNav: { href: string; label: string; icon: React.ReactNode; badge?: AdminBadgeKey }[] = [
  ...
  { href: '/dashboard/admin/shifts',    label: 'シフト管理',     icon: <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" /></svg>, badge: 'shifts' },
  { href: '/dashboard/admin/leaves',    label: '有給管理',       icon: <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>, badge: 'leaves' },
  { href: '/dashboard/admin/payslips',  label: '給料明細管理',   icon: <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>, badge: 'payslips' },
...
export default function Sidebar({ role, name }: SidebarProps) {
  ...
  useEffect(() => {
    fetchCounts()
    const interval = setInterval(fetchCounts, 30000) // 30秒ごとに更新
  ...
  return (
    <div className="w-56 min-h-screen flex flex-col" style={{ background: '#141414', borderRight: '1px solid rgba(255,255,255,0.06)' }}>
      ...
      <div className="px-4 py-5 flex items-center gap-2.5" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <span className="text-sm font-semibold flex-1" style={{ color: '#f9fafb' }}>勤怠管理</span>
